...
const Singleabu = ({ navigation, route }) => {
    ...
    const postamb = async () => {
        let Patientid = await AsyncStorage.getItem('user');
        Patientid = await JSON.parse(Patientid).data._id
        let Patientemail = await AsyncStorage.getItem('user');
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        width: "100%",
                        marginLeft: 10
                    }} source={require('../assets/do.png')}></ImageBackground>
                    </View>
                    <View style={{
                        width: "70%",
